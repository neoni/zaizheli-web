...
public class ViewApplicationStatus {
	...
	@RequestMapping(value="/{id}/applications/0", method=RequestMethod.GET)
	...
	@RequestMapping(value="/{id}/applications/1", method=RequestMethod.GET)
	...
	@RequestMapping(value="/{id}/applications/2", method=RequestMethod.GET)
