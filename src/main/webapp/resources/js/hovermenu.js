...
$(function(){
	$.hovermenu('init',{
		buttons:{
			"tl":{ text:"热门活动 ", callback: function(){window.location = web_context + "/hot";}}, 
			"tr":{ text:"瀑布布局", callback: function(){window.location = web_context + "/";}},
			"bl":{text:"地图布局", callback: function(){window.location = web_context + "/map"; }},
			"br":{text:"随机活动", callback: function(){window.location = web_context + "/random";}}
		}
	});
